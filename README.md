...
Columns include 'brokered_by', 'status', 'price', 'bed', 'bath', 'acre_lot', 'street',
       'city', 'state', 'zip_code', 'house_size', 'prev_sold_date',
       'sold_year', 'sold_month', 'median_hh_income', 'urban_density_ratio',
       'state_in_migration_rate', 'west_cpi_inflation',
       'us_30yr_mortgage_rate', 'ca_unemployment_rate', 'log_price',
       'log_house_size', 'is_cost_burdened'
